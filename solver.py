...
class RCPSP_solver():
    def __init__(self, jobs, duration, predecessors, resources, requests, shifts, orders):
        self.jobs = jobs
        self.dur = duration
    ...
    def solve(self, time_limit=60):
        ...
        if self.sol.is_solution():
            print(f"Optimal tardiness: {self.sol.get_objective_value()}")
